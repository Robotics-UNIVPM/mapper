...
public:
    ...
    /**< TODO: separate RAW and Scaled GET */
    void getRawMeasurement(int16_t xyz_AccTemGyr[])
    {
        uint8_t _data[14];
        i2c.read(I2C_ADDRESS,REG_ACCEL_XOUT_H, _data, 14);
        // RAW
        ...
        xyz_AccTemGyr[3] = int16_t(_data[8]<<8 | _data[9]); // GYR
        xyz_AccTemGyr[4] = int16_t(_data[10]<<8| _data[11]);
        xyz_AccTemGyr[5] = int16_t(_data[12]<<8| _data[13]);
